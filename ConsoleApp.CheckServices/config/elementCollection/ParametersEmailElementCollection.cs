...
{
    internal class ParametersEmailElementCollection : ConfigurationElementCollection
    {

        public ParametersEmailElement this[int index]
        {
            get
            {
                // Gets the SageCRMInstanceElement at the specified
                // index in the collection
                return (ParametersEmailElement)BaseGet(index);
            }
            set
            {
        ...
        public new ParametersEmailElement this[string key]
        {
            get
            {
                // Gets the SageCRMInstanceElement where the name
                // matches the string key specified
                return (ParametersEmailElement)BaseGet(key);
            }
            set
            {
        ...
        {
            return new ParametersEmailElement();
        }
        ...
        {
            return ((ParametersEmailElement)element).From;
        }
